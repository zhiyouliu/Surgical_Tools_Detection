...
gpu_ids="0"
NUM_OF_GPU=1
name="Deformal_DETR_Surgical_tool_pretrain_R50_num_classes_4_detr+1_setting_with_box_refine_more_resize"
output_dir="./outputs_pretrain_deformal_detr_R50_num_classes_4_detr+1_setting_with_box_refine_more_resize"
log="log_train_R50_pretrain_num_classes_4_detr+1_setting_with_box_refine_more_resize.txt"
